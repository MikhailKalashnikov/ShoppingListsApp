 ...
 * 
 * Modified by Mikhail Kalashnikov
 * In the constructor remove mbContainer view from container if view already exists
 *
 */
...
public class MessageBar {
    ...
    public MessageBar(Activity activity) {
        ...
        for(int i=0;i<container.getChildCount();i++){
        	if(container.getChildAt(i).getId() == R.id.mbContainer){
