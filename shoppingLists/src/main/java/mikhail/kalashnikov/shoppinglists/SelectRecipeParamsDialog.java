...
public class SelectRecipeParamsDialog extends DialogFragment {
    ...
    private static CheckBox mCBUseRecipeName;
    private static String mRecipeName;
    private static String mDflCategoryName;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mDflCategoryName = getArguments().getString("category_name");
        ...
        mListName.setOnClickListener(new View.OnClickListener() {
                                         ...
                                         public void onClick(View v) {
                                             (new PickListDialog()).show(getActivity().getSupportFragmentManager(), "PickListDialog");
                                         }
                                     }
        );
...
//        });
        ...
        if (useCategory) {
            ...
            mCategoryName.setText(mDflCategoryName);
            mCategoryName.setOnClickListener(new View.OnClickListener() {
                                                 @Override
                                                 public void onClick(View v) {
                                                     (new PickCategoryDialog()).show(getActivity().getSupportFragmentManager(), "PickCategoryDialog");
                                                 }
                                             }
            );
...
//            });
    ...
    public static class PickListDialog extends DialogFragment  {
    ...
    public static class PickCategoryDialog extends DialogFragment  {
        @Override
        public Dialog onCreateDialog(Bundle savedInstanceState) {
